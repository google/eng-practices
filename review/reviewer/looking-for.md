...
during a code review is if there is some sort of **parallel or asynchronous programming** going
...
complexity in tests just because they aren't part of production code.
...
reformatting to as one PR, and then send another PR with their functional
changes after that.
...
READMEs, yard docs, and any other auto-generated documentation. If the PR deletes
or deprecates code, consider whether the documentation should also be deleted.
If reasonable documentation is missing, ask for it.
