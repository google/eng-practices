...
When you've sent a CL out for review, your reviewer will likely
...
In general, if a reviewer isn't providing feedback in a constructive way
and polite, explain this to them in person. If you can't talk to them in person
or on a video call, then send them a private email. Kindly explain to them what you don't like and what you'd like them to do differently. If they also
...
If a reviewer didn't understand some piece of your code, likely, other
...
codebase, users, and/or Google. Often, reviewers are providing
*suggestions* and they want you to think for yourself about what's best. You
might know something about the users, codebase, or CL that the reviewer
